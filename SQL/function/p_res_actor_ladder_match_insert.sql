...
BEGIN
  INSERT INTO res_actor_ladder_match (actor_id, season_id, ladder_match_integral, 
    ladder_match_time, winning_time, winning_rate, 
    show_money_give_reward, medal_give_reward, show_money_count, 
    medal_id, receive_show_money, create_time, 
    update_time)
  VALUES (i_actorId, i_seasonId, i_ladderMatchIntegral, 
    i_ladderMatchTime, i_winningTime, i_winningRate, 
    i_showMoneyGiveReward, i_medalGiveReward, i_showMoneyCount, 
    i_medalId, i_receiveShowMoney, i_createTime, 
    i_updateTime);
  o_tagcode := '00000000';
